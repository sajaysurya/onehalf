...
let s:bg_red      = { "gui": "#563c44", "cterm": "174" }
let s:bg_green    = { "gui": "#44514b", "cterm": "101" }
let s:bg_yellow   = { "gui": "#575145", "cterm": "180" }
let s:bg_orange   = { "gui": "#c26100", "cterm": "180" }
...
call s:h("DiffAdd", "", s:bg_green, "")
call s:h("DiffChange", "", s:bg_yellow, "")
call s:h("DiffDelete", "", s:bg_red, "")
call s:h("DiffText", s:fg, s:bg_orange, "")
